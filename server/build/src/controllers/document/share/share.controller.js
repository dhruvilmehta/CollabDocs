...
const documentUser_model_1 = require("../../../db/models/documentUser.model");
class ShareController {
    constructor() {
        this.create = (0, catch_async_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!sharedUser)
                return res.sendStatus(400);
            const documentUser = yield documentUser_model_1.DocumentUser.create({
                documentId: id,
        ...
        this.delete = (0, catch_async_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const documentUser = yield documentUser_model_1.DocumentUser.findOne(query);
            if (!documentUser)
                return res.sendStatus(400);
            yield documentUser_model_1.DocumentUser.destroy(query);
