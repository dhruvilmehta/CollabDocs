...
const permission_enum_js_1 = __importDefault(require("../../types/enums/permission.enum.js"));
...
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => document_model_js_1.Document),
    __metadata("design:type", document_model_js_1.Document)
], DocumentUser.prototype, "document", void 0);
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => document_model_js_1.Document),
    sequelize_typescript_1.PrimaryKey,
    sequelize_typescript_1.Column,
    __metadata("design:type", Number)
