...
const refreshToken_model_js_1 = require("../db/models/refreshToken.model.js");
const mail_services_js_1 = require("./mail.services.js");
class UserService {
    constructor() {
        this.findUserByEmail = (email) => __awaiter(this, void 0, void 0, function* () {
            const user = yield user_model_js_1.User.findOne({ where: { email } });
            return user;
        });
        this.createUser = (email, password) => __awaiter(this, void 0, void 0, function* () {
            ...
            const user = yield user_model_js_1.User.create({
                email: email,
        ...
        this.sendVerificationEmail = (user) => __awaiter(this, void 0, void 0, function* () {
            const mail = {
                from: "dhruvilmehta2606@gmail.com",
                to: user.email,
            ...
            yield mail_services_js_1.mailService.sendMail(mail);
        });
        ...
        this.getRequestUser = (user) => __awaiter(this, void 0, void 0, function* () {
            if (user instanceof user_model_js_1.User) {
                const userWithRoles = yield user_model_js_1.User.scope('withRoles').findByPk(user.id);
        ...
        this.generateAuthResponse = (user) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield refreshToken_model_js_1.RefreshToken.destroy({
                where: { userId: requestUser.id }
            });
            yield refreshToken_model_js_1.RefreshToken.create({ token: refreshToken, userId: requestUser.id });
            return { accessToken, refreshToken };
        });
        this.getIsTokenActive = (token) => __awaiter(this, void 0, void 0, function* () {
            const refreshToken = yield refreshToken_model_js_1.RefreshToken.findOne({
                where: { token: token }
            });
        ...
        this.findUserById = (id) => __awaiter(this, void 0, void 0, function* () {
            const user = yield user_model_js_1.User.findByPk(id);
            return user;
        });
        this.resetPassword = (user) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield user.update({ passwordResetToken: passwordResetToken });
        ...
        this.findUserByPasswordResetToken = (email, passwordResetToken) => __awaiter(this, void 0, void 0, function* () {
            const user = yield user_model_js_1.User.findOne({
                where: {
                    email,
                    passwordResetToken
                }
