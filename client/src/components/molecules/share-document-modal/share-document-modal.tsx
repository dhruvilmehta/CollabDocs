...
const ShareDocumentModal = () => {
  ...
  const publicAccessBtn=(<div className="space-y-1">
  ...
  <div className="space-y-1">
    ...
    <p className="mx-2">
      ...
      <span className="text-gray-600">Only people can open with this link</span>
    </p>
  </div>
  )
          ...
          >
            <div className="rounded-md bg-white shadow-xl p-4 space-y-4">
              ...
              <div className="w-full flex justify-end space-x-2">
                <button onClick={handleShareBtnClick} disabled={loading || email===null || !validator.isEmail(email) || alreadyShared} className={`${email===null || !validator.isEmail(email) || alreadyShared ? 'btn-disabled' : 'btn-primary'} px-6`}>
            ...
            <div className="rounded-md bg-white shadow-xl p-4 space-y-4 flex flex-col">
              ...
              <div className="flex justify-between items-center">
                ...
                <button onClick={handleCopyLinkBtnClick} className="font-semibold text-blue-600 p-2 hover:bg-blue-50 rounded-md">
                  Copy Link
                </button>
              </div>
            </div>
