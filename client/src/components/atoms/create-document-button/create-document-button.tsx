...
const CreateDocumentButton=()=>{
    ...
    const handleDocumentCreateButtonClick=async ()=>{
            ...
            <div className="w-full h-full max-w-4xl py-4 space-y-4 overflow-auto">
                ...
                <div className="flex items-center">
                    <div className="space-y-2">
                        <button disabled={loading} onClick={()=>handleDocumentCreateButtonClick()} className="h-52 w-40 bg-white border hover:border-blue-500 flex items-center justify-center">
